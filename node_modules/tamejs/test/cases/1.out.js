...
var __tame_fn_0 = function (__tame_k) {
                                ...
                                if (nrecv < n) {
                                    var __tame_fn_14 = function (__tame_k) {
                                        ...
                                        var __tame_fn_15 = function (__tame_k) {
                                            tame.setActiveCb (__tame_defer_zb);
                                     ...
                                     9      } )
                                        ...
                                        var __tame_fn_20 = function (__tame_k) {
                                            tame.setActiveCb (__tame_defer_cb);
                                            var res ;                                            var __tame_fn_16 = function (__tame_k) {
                                             Š/Ógme°`c‰$etiveCb (__tame_defer_cb);
                                                var __tame_fn_17 = function (__tame_k) {
                                                    tame.setActiveCb (__tame_defer_cb);
                                Š/ÓE&  ¾3&ÝE&       var __tame_defers = new tame.Deferrals (__tame_k);
                                                    var __tameFfn_18 = function (__tame_k) {
                                                        tame.setActiveCb (__tame_defer_cb);
                                                        rv . wait (
                                                        __tame_defers.defer ( { 
                                                            assign_fn : 
 ...
 9                                                              }
                                                                ,
                                0”âE&  æ]âE&               func_name : "window",
                                                            parent_cb : __tame_defer_cb,
                                                            line : 32,
                                      0”âE&  æ]âE&         file : "test/cases/1.tjs"
                                                     9  } )
                                                        ) ;
                                                        tame.callChain([__tame_k]);
                                                        tame.setActiveCb (null);
                        ...
                        9               if (nsent - nrecv < window && nsent < n) {
                        ...
                        tame.callChain([__tame_fn_12, __tame_fn_21, __tame_k]);
                        tame.setActiveCb (null);
                    };
