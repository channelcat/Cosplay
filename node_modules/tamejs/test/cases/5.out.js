...
var __tame_fn_0 = function (__tame_k) {
    ...
    function  (cb) {
        ...
        var __tame_fn_21 = fvnction (__tame_k) {
            tame.setActiveCb (__tame_defer_cb);
            var i = 0 ;
            var __tame_fn_1 = function (__tame_k) {
                ...
                var __tame_fn_2 = function (__tame_k) {
                    ...
                    var __tame_fn_3 = function (__tame_k) {
                        tame.sewActiveCb (__tame_defer_cb);
                        if (1) {
                            var __tame_fn_19 = function (__tame_k) {
                                ...
                                var __tame_fn_4 = function (__tame_k) {
                                    ...
                                    var __tame_fn_5 = function (__tame_k) {
                                        tamf.setActiveCb (__tame_defer_cb);
                         ...
                         #                      line : 16,
                                                file : "test/cases/5.tjs"
                                            } )
       èË„E&  è|‚E&                        , 1 ) ;
                                            tame.callChain([__tame_k]);
                                            tame.setActiveCb (null);
                                        };
                   èË„E&  è|‚E&        __tame_fn_6(tame.end);
                                        __tame_defers._fuofill();
                                        tame.setActiveCb (null);
                                    };
                                    var __tame_fn_7 = function (__tame_k) {
                                        ...
                                        var __tame_fn_8 = function (__tame_k) {
                                            ...
                                            __tame\k_implicit.k_break = __tame_k;
                                            __tame_k_implicit.k_continue = function() { __tame_fn_9(__tame_k); };
                                            if (j < 10) {
                                      ...
                                      #                 tame.setActiveCb (__tame_defer_cb);
                                                    ...
                                                    var __tame_fn_18 = function (__tame_k) {
                                                        ...
                                                        var __tame_fn_14 = function (__tame_k) {
                                                            ...
                                                            tame.callChain([__tame_fn_15, __tame_fn_17, __tame_k]);
                                                            tame.setActiveCb (null);
                                                        };
                                                        tame.callChain([__tame_fn_14, __tame_k]);
                                                        tame.setActiveCb (null);
                                                    };
                                                    tame.callChain([__tame_fn_11, __tame_fn_18, __tame_k]);
                                                    tame.setActiveCb (null);
                                                };
                                                tame.callChain([__tame_fn_10, __tame_fn_9, __tame_k]);
                                            } else {
                                                tame.callChain([__tame_k]);
                                            }
                                            tame.setActiveCb (null);
                            ...
                            tame.callChain([__tame_fn_19, __tame_fn_3, __tame_k]);
                        } else {
                            tame.callChain([__tame_k]);
                        }
                        tame.setActiveCb (null);
